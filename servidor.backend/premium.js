...
const { verificaNome, resetarAllLimit, resetTodayReq, banir, desbanir, checkBanimento } = require('../backend/db');
...
const { enviarnozap, enviarnozap_button, enviarnozap_buttontime, enviarbutimg } = require('../japabot');
