...
const { enviarnozap, enviarnozap_button, enviarnozap_buttontime, enviarnozaptime } = require('../japabot');
...
req.flash('error_msg', 'Sua conta não foi verificada, caso a verificação não tenha chegado em seu Whatsapp, fale com o suporte : +5516993025827');
return res.redirect('/i/entrar');
} else {
...
enviarnozap('5516993025827', infowner)
gerarUsuario(username, hashedPassword, apikey, id, nomorWa, 'imgaqui');
req.flash('success_msg', 'cadastro concluído!, foi enviado uma mensagem em seu Whatsapp, caso não tenha recebido a mensagem, contate o suporte! +5516993025827');
return res.redirect('/i/entrar');
}
} else {
