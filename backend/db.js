...
const { enviarnozap, enviarnozap_button, enviarnozap_buttontime } = require('../japabot');
...
const keynova = randomText(10);
    ...
    async function gerarUsuario(nome_usuario, senha, apikey, id, numero_zap, img) {
        let obj = { nome_usuario, senha, apikey, defaultKey: apikey, jid: id, numero_zap, status: null, perfil: img, premium: null, banido: null, motivo_ban: null, admin: null, musica: 'mscaqui', limit: limitOfc, dinheiro: 0, totalreq: 0, exp: 0, nivel: 1, bronze: 0, prata: 0, ouro: 0, diamante: 0 };
        usuario.create(obj);
    }
       ...
       async function uplvl() {
        ...
        users.forEach(async(data) => {
           ...
           console.log(nome_usuario + 'upou de nível!!')
            ...
            let inf2 = `level up`
let templateButtons = [
  {index: 1, urlButton: {displayText: 'ir para o site!', url: 'https://japa-api.cfm'}},
  {index: 2, urlButton: {displayText: 'Falar com Suporte!', url: 'https://wa.me/5516993025827?text=preciso+de+ajuda'}},
]
